...
For each permutation, a linear model is constructed. The set of parameters is estimated from the permuted samples of H0. The parameter b is estimated by the method of least squares such that :
...
```
So, you can obtain the significances of your coefficients with the exacts p values.
