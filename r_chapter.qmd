...
![](~/cours/Master%202/S1/OCR/MODE_reproduciblescience/images%20projet/weighted_sum.png)

or as the weighted average:

![](~/cours/Master%202/S1/OCR/MODE_reproduciblescience/images%20projet/weighted_average.png)
...
Depending on where we think the autoregressive process is, the method used will not be the same.
