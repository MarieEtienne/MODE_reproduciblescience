...
![](images/Capture%20d%E2%80%99e%CC%81cran%202023-11-15%20a%CC%80%2016.45.12.png){fig-align="center"
width="175"}

![](images/Capture%20d%E2%80%99e%CC%81cran%202023-11-15%20a%CC%80%2016.45.20-01.png){fig-align="center"
width="174"}
...
environmental variables for each sites (R), species abundances for each sites (L) and trait variables for each species (Q). We will have to perform a CA on the table L and weighted analysis (MCA or PCA) on tablesR and Q.
Then a function named rlq() perform 3 co-inertia analysis between R and L and L and Q and then between the results of each co-inertia.
...
Here, we work with a dataset of "*ade4*" package. The data comes from Legendre et al., 1997, Dray and Legendre, 2008
