...
perform a CA on the table L and weighted analysis (MCA or PCA) on tables
R and Q. Then a function named rlq() perform 3 co-inertia analysis
...
decide what analysis to use, you can have a look to this decision tree !
