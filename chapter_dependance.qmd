...
#Import dataset
div35=read.table("https://github.com/MarieEtienne/MODE_reproduciblescience/blob/master/div35.txt", header=T, dec=",")
...
#Import the dataset
mare=read.table("https://github.com/MarieEtienne/MODE_reproduciblescience/blob/master/mares.txt",header=TRUE)
...
![**Figure 2.15 :** Illustration, on Parisian census districts (IRIS), of the gap between random distribution and spatially autocorrelated distribution - Source: INSEE, Localised Tax Revenues System (RFL) 2010](images/image-1092496314.png)
...
> ![**Figure 2.16 :** Output of the Monte Carlo test](images/image-318830441.png){width="380"}
...
![**Figure 2.17 :** Values of local Moran's I, on Parisian IRIS - Source: INSEE, Localised Tax Revenues System (RFL) 2010](images/image-979262065.png)
