...
```{r}
## Load the data
githubURL=("https://github.com/MarieEtienne/MODE_reproduciblescience/blob/master/vautour.txt")
dataT=read.table(githubURL,header=T,dec=",", stringsAsFactors = T)
...
```{r}
div35 <- read.table("Spatial autocorrelation_ modelisation\div35.txt", header=T, dec=",")
