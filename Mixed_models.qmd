...
Compte tenu de la configuration expérimentale, cette méthode n'est pas appliquée ici.
...
library(nlme)
# Modèle complet
mod1<-lme(fixed=body_mass_g~species*island*sex,random=~1|year,data=df)
lme4::lmer(body_mass_g~species*island*sex + (1|year), data=df)
```
