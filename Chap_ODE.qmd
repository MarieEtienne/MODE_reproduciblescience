...
Présentation graphique avec 1 trajectoires

```{r}
trajectory()
```

Maintenant que se passe t'il dans cas à 10 trajectoires

```{r}
trajectory()
```

De manière générale il est important de tracer plusieurs trajectoires pour comprendre comportemement modèles
