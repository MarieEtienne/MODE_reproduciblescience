...
For our example, we will talk about numbers of individuals (Xinit=10 individuals, Yinit=4 individuals), and we will consider the time unit to be weeks. But we could have chosen days or years, and then chose consistent coefficient values
...
par(mfrow=c(2,1))
plot(x=t, y=X, xlab="Time(weeks)", ylab="Prey(nb of individuals)") #to plot the evolution of prey over time
plot(x=t, y=Y, xlab="Time(weeks)", ylab="Predator(nb of individuals)")#to plot the evolution of predator over time

#to plot a phase space plot, i.e the level of predator as a function of the prey level
plot (x=X, y=Y, xlab="Prey(nb of individuals)", ylab="Predator (nb of individuals)")
